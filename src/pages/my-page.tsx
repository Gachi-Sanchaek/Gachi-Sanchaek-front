...
export default function MyPage() {
  ...
  if (loading) return <div className='w-full h-screen flex justify-center items-center font-[PretendardVariable] text-[#FFFFFF]'>로딩중...</div>;
  if (error) return <div className='w-full h-screen flex justify-center items-center font-[PretendardVariable] text-[#FFFFFF]'>{error}</div>;
            ...
            <div className='ml-2 flex items-center'>
              {isEditing ? (
                <input
                  ...
                  className={`text-white font-[PretendardVariable] font-medium text-[22px] bg-transparent border-none outline-none caret-white ${shake ? 'shake' : ''}`}
                  onKeyDown={(e) => {
                      ...
                      return (
                        <div key={p.date} className='flex justify-between h-16 items-center font-[PretendardVariable]'>
                          ...
                          <div className='flex flex-col flex-1 ml-2 justify-center'>
                            <span className='font-medium text-[16px]'>{walkAuthType(p.title)}</span>
