...
export default function WalkEndPage() {
  ...
  const { nickname, walkingCount, totalDistance, totalMinutes, pointsEarned } = data;
  return (
    <>
      <div className='flex flex-col items-center justify-center w-full h-[calc(100vh-136px)] gap-4'>
        ...
        <p className='text-2xl font-semibold text-center'>
          <span className='text-[#5fd59b] font-[PretendardVariable]'>{pointsEarned}포인트</span>
          <span className='text-black font-[PretendardVariable]'>를 받았어요!</span>
        </p>
      </div>
