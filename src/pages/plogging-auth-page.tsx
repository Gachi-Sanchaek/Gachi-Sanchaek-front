...
export default function PloggingAuthPage() {
  ...
  return (
    <div className="relative w-full h-[100dvh] flex flex-col justify-center items-center gap-1 bg-black">
      <button
        type="button"
        className="absolute top-10 right-6 cursor-pointer p-1"
      ...
      <video
        ...
        className="w-full max-w-[400px] object-cover aspect-square px-5 pointer-events-none"
      />
      ...
      <div className="absolute bottom-7 border-3 border-white rounded-full bg-transparent w-18 h-18 flex justify-center items-center">
        <button
          ...
          className="w-15 h-15 bg-white text-white rounded-full cursor-pointer active:w-13 active:h-13"
        />
      </div>
      ...
      {showCloseModal && (
        <Modal
          title={
            <>
              산책을 그냥 종료하면 포인트가 적립되지 않아요. <br /> 그래도
              종료하시겠어요?
            </>
          }
          buttons={[
