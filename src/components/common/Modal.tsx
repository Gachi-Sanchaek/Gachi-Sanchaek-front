...
const Modal = ({ title, buttons = [] }: ModalProps) => {
  ...
  return (
    <div role='dialog' aria-modal='true' className='fixed inset-0 flex items-center justify-center bg-black/40 z-[1000] p-4'>
      <div className='w-1/3 max-w-[480px] px-8 py-6 bg-white rounded-xl shadow-[0px_2px_4px_rgba(0,0,0,0.25)] flex flex-col gap-6'>
